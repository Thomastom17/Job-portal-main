...
export const Tier2plan = ({ onBack, initialData }) => {
  ...
  const [formData, setFormData] = useState({
    tierType: "Tier2Plan",
    planName: initialData?.planName || "Professional Employer Plan",
    planType: initialData?.planType || "Growth Plan",
    description: initialData?.description || "An intermediate plan for growing companies...",
    price: initialData?.price || "499", 
    billingCycle: initialData?.billingCycle || "Half-Yearly",
    duration: initialData?.duration || "180",
    discount: initialData?.discount || "8", 
    ...
    TrailDuration: initialData?.TrailDuration || "5", 
    GraceTime: initialData?.GraceTime || "2",
    planTags: initialData?.planTags || ["Popular"],
  ...
  const handleSaveDraft = () => {
    console.log("Final Saved Data Object (Tier 2 - Schema Matched):", formData);
    alert("Tier 2 Plan details saved successfully with Schema structure!");
  };
      ...
      <div className="membership-layout-flex">
        <div className="form-left-sections">
          ...
          <div className="section-card">
            <h3><span className="section-number">1</span> Basic plan details (Tier 2)</h3>
        ...
        <div className="preview-right-sidebar">
          <div className="preview-card-container">
            <div className="preview-card-banner" style={{ backgroundColor: '#1e3a8a' }}>
            ...
            <div className="preview-card-body">
              ...
              <button className="btn-get-started" style={{ backgroundColor: '#1e3a8a' }}>Get started</button>
            </div>
          </div>
        </div>
