...
export const FindTalent = () => {
  ...
  const filterOptions = useMemo(() => {
    ...
    Alluser.forEach(user => {
      if (user.preferences[0]?.jobType) workTypes.add(user.preferences[0].jobType);
  ...
  const filteredTalent = useMemo(() => {
    return Alluser.filter((user) => {
      ...
      return matchesSearch && matchesWorkType && matchesLanguage && matchesEducation && matchesSkills && matchesExperience;
    });
  }, [searchTerm, selectedWorkTypes, selectedLanguages, selectedEdu, selectedSkills, maxExp]);
  ...
  return (
    ...
    <div className="talent-page-container">
      <section style={{marginTop:"40px"}} className="FindTalent-search-section">
      ...
      <div className="FindTalent-layout-body">
        <div className="FindTalent-filters-sidebar">
          ...
          {/* Work Type - Usually few, so no slice needed, but can add if needed */}
        ...
        {/* --- Main List (Original Card Structure) --- */}
            ...
            <div className="FindTalent-talent-card" key={index}>
              ...
              <div className="FindTalent-card-bottom">
                ...
                <div className="FindTalent-actions">
                  ...
                  <button className="FindTalent-btn-view">View profile</button>
                </div>
              </div>
            </div>
          ))}
